...
def main():
    ...
    train_data = None
    if args.do_train:
        train_data = data_util.Loader('/chpc/home/stu-ysfang-a/bert-cloth', data_file['train'], args.cache_size, args.train_batch_size, device)
        num_train_steps = int(
            train_data.data_num / args.train_batch_size / args.gradient_accumulation_steps * args.num_train_epochs)

    # Prepare model
    model = BertForCloth.from_pretrained('/chpc/home/stu-ysfang-a/BERT-data/bert-large-uncased',
    ...
    if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        valid_data = data_util.Loader('/chpc/home/stu-ysfang-a/bert-cloth', data_file['valid'], args.cache_size, args.eval_batch_size, device)
